...
public class AE_Example014 extends TestBase {
    ...
    public void test() {
        ...
        List<WebElement> addItemButtonList = driver.findElements(By.xpath
                ("//a[@class='btn btn-default add-to-cart']"));
        new Actions(driver).sendKeys(Keys.PAGE_DOWN).perform();
        addItemButtonList.get(0).click();
        WebElement continueShopping = driver.findElement(By.xpath
                ("//button[@class='btn btn-success close-modal btn-block']"));
        continueShopping.click();
        addItemButtonList.get(2).click();
        continueShopping = driver.findElement(By.xpath
                ("//button[@class='btn btn-success close-modal btn-block']"));
        continueShopping.click();
        ...
        WebElement registerLogin = driver.findElement(By.xpath
                ("//u[text()='Register / Login']"));
        registerLogin.click();
        ...
        boolean isAccountCreatedDisplayed  = driver.findElement(By.xpath
                ("//b[text()='Account Created!']")).isDisplayed();
        ...
        String actualNameSurname = driver.findElement(By.xpath
                ("(//ul[@id='address_delivery']//li)[2]")).getText(); //title, isim, soyisim
        String expectedNameSurname = "Mr. " + isim + " " + soyisim;
        Assert.assertEquals(expectedNameSurname, actualNameSurname);

        String actualSirketIsimi = driver.findElement(By.xpath
                ("(//ul[@id='address_delivery']//li)[3]")).getText(); //title, isim, soyisim
        ...
        String actualAddress2 = driver.findElement(By.xpath
                ("(//ul[@id='address_delivery']//li)[5]")).getText(); //title, isim, soyisim
        Assert.assertEquals(address2, actualAddress2);

        String expectedStateCityZipCode = address2 + " " + state + " " + zipCode;
        String actualStateCityZipCode = driver.findElement(By.xpath
                ("(//ul[@id='address_delivery']//li)[6]")).getText(); //title, isim, soyisim
        Assert.assertEquals(expectedStateCityZipCode, actualStateCityZipCode);

        String actualCountry = driver.findElement(By.xpath
                ("(//ul[@id='address_delivery']//li)[7]")).getText(); //title, isim, soyisim
        Assert.assertEquals("Canada", actualCountry);

        String expectedPhoneNo = "02122121212";
        String actualPhoneNo = driver.findElement(By.xpath
                ("(//ul[@id='address_delivery']//li)[8]")).getText(); //title, isim, soyisim
